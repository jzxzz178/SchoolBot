...
public class BotManager : IBotManager
{
    ...
    public BotManager(IMenuDataManager menuDataManager, IUserLogManger userLogManger, IErrorLogManager errorLogManager)
    {
    ...
    {
        if (day == null || meal == null) errorLogManager.LoggingError($"Null request to db!!! || Day: {day}; Meal: {meal}");
